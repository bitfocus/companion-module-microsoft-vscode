...
import { Client, configureServer, request, startServer, stopServer } from './server'
...
export class Module extends InstanceBase<Config> {
  ...
  public static updateStatus(status: InstanceStatus) {
  ...
  private generateActionDefinitions() {
    ...
    const actions: CompanionActionDefinitions = {
      ...
      debug_stop: {
        ...
        options: [],
        callback() {
          request({ id: null, type: 'debug-stop' })
        },
      },
      activate: {
